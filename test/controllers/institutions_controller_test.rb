...
class InstitutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create institution" do
    assert_difference("Institution.count") do
      post institutions_url, params: { institution: { cnpj: @institution.cnpj, name: @institution.name, type: @institution.type } }, as: :json
    end
  ...
  test "should update institution" do
    patch institution_url(@institution), params: { institution: { cnpj: @institution.cnpj, name: @institution.name, type: @institution.type } }, as: :json
    assert_response :success
  end
